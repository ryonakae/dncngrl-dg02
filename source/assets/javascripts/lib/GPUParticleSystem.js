...
THREE.GPUParticleSystem = function(options) {
	...
	self.particleNoiseTex = textureLoader.load("./assets/images/textures/perlin-512.png");
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	self.particleSpriteTex = textureLoader.load("./assets/images/textures/particle2.png");
